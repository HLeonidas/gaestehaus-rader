...
const translations: Record<Lang, Record<string, string>> = {
	de: {
		...
		'experiences.event.summer.gorge.kicker': 'Natur',
		'experiences.event.summer.gorge.title': 'Wasserfall & Schluchtweg',
		'experiences.event.summer.gorge.description':
			'Kühler Schatten, feine Gischt und ein Weg, der auch an heißen Tagen gut tut.',
		'experiences.event.summer.food.kicker': 'Genuss',
		'experiences.event.summer.food.title': 'Bauernhofladen & Brettljause',
		'experiences.event.summer.food.description':
			'Käse, Speck und Brot vom Tal: regional einkaufen und draußen in Ruhe genießen.',
		...
		'experiences.event.winter.ski.description':
			'Kärntens größtes Skigebiet mit 110 Pistenkilometern und vielen Liften - ideal für Tagesausflüge.',
		'experiences.event.winter.ice.kicker': 'Eis',
		'experiences.event.winter.ice.title': 'Eislaufen am Weißensee',
		'experiences.event.winter.hike.kicker': 'Winterwandern',
		'experiences.event.winter.hike.title': 'Schneeschuh & Wege',
		'experiences.event.winter.crosscountry.kicker': 'Langlaufen',
		...
		'experiences.event.winter.snowshoe.kicker': 'Schneeschuh',
		'experiences.event.winter.snowshoe.title': 'Schneeschuhwandern',
		'experiences.event.winter.snowshoe.description':
			'Frischer Schnee unter den Schuhen, leise Wälder und Panorama, das den Kopf frei macht.',
		'experiences.event.winter.sledding.kicker': 'Rodeln',
		'experiences.event.winter.sledding.title': 'Rodeln am Abend',
		'experiences.event.winter.sledding.description':
			'Lachen in der kalten Luft, rote Wangen und ein einfacher Abend mit viel Wintergefühl.',
		...
		'experiences.event.winter.ski.meta1': 'Skitage am Nassfeld',
		'experiences.event.winter.ski.meta2': 'Nachmittags zurück ins Ruhige',
		'experiences.event.winter.ice.meta1': 'Natureis-Highlight am Weißensee',
		'experiences.event.winter.ice.meta2': 'Ideal für aktive Wintertage',
		'experiences.event.winter.hike.meta1': 'Ruhige Wege mit Weitblick',
		'experiences.event.winter.hike.meta2': 'Auch für Genießer geeignet',
		'experiences.event.winter.crosscountry.meta1': 'Loipen nah bei Weißbriach',
		'experiences.event.winter.crosscountry.meta2': 'Von leicht bis sportlich',
	...
	en: {
		...
		'experiences.event.summer.gorge.kicker': 'Nature',
		'experiences.event.summer.gorge.title': 'Waterfall & Gorge Trail',
		'experiences.event.summer.gorge.description':
			'Cool shade, fine spray, and a refreshing path for hot summer days.',
		'experiences.event.summer.food.kicker': 'Food',
		'experiences.event.summer.food.title': 'Farm Shop & Alpine Snack',
		'experiences.event.summer.food.description':
			'Local cheese, cured ham, and bread from the valley, perfect for a slow outdoor break.',
		'experiences.event.winter.ski.kicker': 'Skiing',
		'experiences.event.winter.ski.title': 'Nassfeld: Sun Ski World',
		'experiences.event.winter.ski.description':
			'Carinthia’s largest ski area with 110 km of slopes and many lifts - ideal for day trips.',
		'experiences.event.winter.ice.kicker': 'Ice',
		'experiences.event.winter.ice.title': 'Ice skating on Lake Weißensee',
		'experiences.event.winter.hike.kicker': 'Winter hiking',
		'experiences.event.winter.hike.title': 'Snowshoeing & trails',
		'experiences.event.winter.crosscountry.kicker': 'Cross-country',
		...
		'experiences.event.winter.snowshoe.kicker': 'Snowshoeing',
		'experiences.event.winter.snowshoe.title': 'Snowshoe Hikes',
		'experiences.event.winter.snowshoe.description':
			'Fresh snow underfoot, quiet forests, and open views that clear your head.',
		'experiences.event.winter.sledding.kicker': 'Sledding',
		'experiences.event.winter.sledding.title': 'Evening Sledding',
		'experiences.event.winter.sledding.description':
			'Cold air, red cheeks, and easy winter fun for the whole family.',
		...
		'experiences.event.winter.ski.meta1': 'Ski days at Nassfeld',
		'experiences.event.winter.ski.meta2': 'Back to calm by afternoon',
		'experiences.event.winter.ice.meta1': 'Natural ice highlight at Weißensee',
		'experiences.event.winter.ice.meta2': 'Ideal for active winter days',
		'experiences.event.winter.hike.meta1': 'Quiet trails with wide views',
		'experiences.event.winter.hike.meta2': 'Also great for relaxed pace',
		'experiences.event.winter.crosscountry.meta1': 'Trails near Weißbriach',
		'experiences.event.winter.crosscountry.meta2': 'From easy to sporty',

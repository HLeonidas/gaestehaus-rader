...
const translations: Record<Lang, Record<string, string>> = {
	de: {
		...
		'usp.1.body': 'Viel Raum, alpine Materialien und moderne Ausstattung für 2-3 Personen.',
	...
	en: {
		...
		'usp.1.body': 'Spacious layouts, alpine materials, and modern comforts for 2-3 guests.',

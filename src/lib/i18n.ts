...
const translations: Record<Lang, Record<string, string>> = {
	de: {
		...
		'experiences.event.summer.lift.description':
			'Mit Millennium-Express, Gartnerkofel- und Madritschenbahn bequem hinauf - und mit Panorama weiterwandern oder biken.',
	...
	en: {
		...
		'experiences.event.summer.lift.description':
			'Take the Millennium Express, Gartnerkofel, and Madritschen lifts up comfortably, then keep going on panoramic hikes or bike routes.',

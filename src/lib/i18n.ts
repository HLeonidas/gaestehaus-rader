...
const translations: Record<Lang, Record<string, string>> = {
	de: {
		...
		'experiences.season.summer.kicker': 'Aktiv & Natur',
		'experiences.season.summer.title': 'Sommer Erlebnisse im Gitschtal',
		...
		'experiences.season.winter.kicker': 'Schnee & Stille',
		'experiences.season.winter.title': 'Winter Erlebnisse im Gitschtal',
		'experiences.season.winter.subtitle':
			'Pulverschnee, Panorama und gemütliche Hütten - erleben Sie die Alpen im Winter.',
		'experiences.badge.includedCard': 'Inklusive Card',
		'experiences.badge.popular': 'Beliebt',
		'experiences.event.summer.hike.kicker': 'Wanderlust',
		'experiences.event.summer.hike.title': 'Wandern im Gitschtal',
		'experiences.event.summer.hike.description':
			'Entdecken Sie über 100km markierte Wanderwege direkt vor unserer Haustür.',
		'experiences.event.summer.lake.kicker': 'Erfrischung',
		'experiences.event.summer.lake.title': 'Baden am Pressegger See',
		'experiences.event.summer.bike.kicker': 'Action',
		'experiences.event.summer.bike.title': 'Mountainbike & E-Bike',
		'experiences.event.summer.lift.kicker': 'Highlight',
		'experiences.event.summer.lift.title': 'Sommerbergbahnen',
		'experiences.event.summer.lift.description':
			'Mühelos auf den Gipfel: Kostenlose Nutzung der Bergbahnen in der Region Nassfeld.',
		'experiences.event.winter.ski.kicker': 'Skigebiet',
		'experiences.event.winter.ski.title': 'Skifahren am Nassfeld',
		'experiences.event.winter.ski.description':
			'Eines der größten Skigebiete Österreichs - perfekt für Familien und Genießer.',
		'experiences.event.winter.ice.kicker': 'Natur-Eis',
		'experiences.event.winter.ice.title': 'Eislaufen am Weißensee',
		'experiences.event.winter.hike.kicker': 'Ruhe',
		'experiences.event.winter.hike.title': 'Winterwandern',
		'experiences.event.winter.crosscountry.kicker': 'Sport',
		'experiences.event.winter.crosscountry.title': 'Langlaufen & Loipen',
		'experiences.event.winter.crosscountry.description':
			'Perfekt präparierte Loipen in der Region Nassfeld-Pressegger See.',
	...
	en: {
		...
		'experiences.tabs.winter': 'Winter',
		'experiences.season.summer.kicker': 'Active & nature',
		'experiences.season.summer.title': 'Summer experiences in the Gitschtal',
		'experiences.season.summer.subtitle':
			'Discover untouched nature, crystal-clear lakes, and alpine adventures for the whole family.',
		'experiences.season.winter.kicker': 'Snow & stillness',
		'experiences.season.winter.title': 'Winter experiences in the Gitschtal',
		'experiences.season.winter.subtitle':
			'Powder snow, panoramic views, and cozy huts - experience the Alps in winter.',
		'experiences.badge.includedCard': 'Included card',
		'experiences.badge.popular': 'Popular',
		'experiences.event.summer.hike.kicker': 'Hiking',
		'experiences.event.summer.hike.title': 'Hiking in the Gitschtal',
		'experiences.event.summer.hike.description':
			'Explore over 100 km of marked hiking trails right on our doorstep.',
		'experiences.event.summer.lake.kicker': 'Refresh',
		'experiences.event.summer.lake.title': 'Swimming at Lake Pressegger',
		'experiences.event.summer.bike.kicker': 'Action',
		'experiences.event.summer.bike.title': 'Mountain biking & e-bikes',
		'experiences.event.summer.lift.kicker': 'Highlight',
		'experiences.event.summer.lift.title': 'Summer cable cars',
		'experiences.event.summer.lift.description':
			'Effortless summit access with free use of cable cars in the Nassfeld region.',
		'experiences.event.winter.ski.kicker': 'Ski area',
		'experiences.event.winter.ski.title': 'Skiing at Nassfeld',
		'experiences.event.winter.ski.description':
			'One of Austria’s largest ski areas - perfect for families and relaxed skiers.',
		'experiences.event.winter.ice.kicker': 'Natural ice',
		'experiences.event.winter.ice.title': 'Ice skating on Lake Weißensee',
		'experiences.event.winter.hike.kicker': 'Calm',
		'experiences.event.winter.hike.title': 'Winter hiking',
		'experiences.event.winter.crosscountry.kicker': 'Sport',
		'experiences.event.winter.crosscountry.title': 'Cross-country skiing',
		'experiences.event.winter.crosscountry.description':
			'Perfectly groomed trails in the Nassfeld–Pressegger See region.',

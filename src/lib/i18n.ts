...
const translations: Record<Lang, Record<string, string>> = {
	de: {
		...
		'usp.1.title': 'Ihr Rückzugsort im Gitschtal',
		'usp.1.body': 'Ruhig urlauben statt Massentourismus - mit viel Raum und echter Erholung.',
		'usp.2.title': 'Alles erreichbar – ohne Stress',
		'usp.2.body': 'Seen, Berge, Wandern und Skifahren liegen nah und sind schnell erreichbar.',
		'usp.3.title': 'Gastgeber, die wirklich da sind',
		'usp.3.body': 'Familiär geführt seit Generationen - persönlich, herzlich und aufmerksam.',
		'usp.4.title': 'Natur direkt vor der Tür',
		'usp.4.body': 'Skigebiet, Wanderwege und Panoramablicke beginnen nur wenige Minuten entfernt.',
		...
		'home.trustbar.quiet': 'Ruhige Lage',
		'home.trustbar.guestcard': 'Gratis Gästekarte',
		'home.trustbar.reviews': 'Top Bewertungen',
		...
		'rooms.page.pricing.extraPrice': '€ 15,-',
		'rooms.page.pricing.tax': 'Kurtaxe pro Erwachsenen (ab 17 Jahre) und pro Tag',
		'rooms.page.pricing.tax.note': 'Erhöhung ab 1. November auf € 4,50',
		'rooms.page.pricing.tax.price': '€ 2,70',
		...
		'room.detail.back': 'Zurück',
		'room.detail.gallery.more': 'Bilder',
		'room.detail.share': 'Teilen',
		'room.detail.shareCopied': 'Link kopiert',
		'room.detail.info.size': 'Größe',
		'room.detail.info.floor': 'Etage',
		'room.detail.info.view': 'Aussicht',
		'room.detail.info.guests': 'Gäste',
		'room.detail.sections.homeTitle': 'Ihr Zuhause in den Alpen',
		'room.detail.sections.amenities': 'Ausstattung',
		'room.detail.sections.floorplan': 'Grundriss',
		'room.detail.sections.prices': 'Preise & Details',
		'room.detail.sections.reviews': 'Gästebewertungen',
		'room.detail.prices.season': 'Saison',
		'room.detail.prices.priceNight': 'Preis / Nacht',
		'room.detail.prices.extraPerson': 'Aufschlag pro weiterer Person',
		'room.detail.prices.extraPersonShort': 'Aufschlag / Person',
		'room.detail.prices.minStay': 'Mindestaufenthalt',
		'room.detail.prices.note':
			'Alle Preise für 2 Personen inkl. gesetzlicher MwSt. zzgl. Endreinigung (einmalig 45 €) und Kurtaxe.',
		'room.detail.reviews.prev': 'Vorherige Bewertungen',
		'room.detail.reviews.next': 'Nächste Bewertungen',
		'room.detail.card.priceFrom': 'Preis ab',
		'room.detail.card.vatNote': 'inkl. MwSt. zzgl. Endreinigung & Ortstaxe',
		'room.detail.card.facts.title': 'Kurze Fakten',
		'room.detail.card.facts.checkinLabel': 'Check-in',
		'room.detail.card.facts.checkinValue': 'ab 14:00 Uhr',
		'room.detail.card.facts.checkoutLabel': 'Check-out',
		'room.detail.card.facts.checkoutValue': 'bis 10:00 Uhr',
		'room.detail.card.facts.minStayLabel': 'Mindestaufenthalt',
		'room.detail.card.facts.minStayValue': '3 Nächte',
		'room.detail.card.facts.cancelLabel': 'Storno',
		'room.detail.card.facts.cancelValue': 'laut Bedingungen',
		'room.detail.card.facts.petsLabel': 'Haustiere',
		'room.detail.card.facts.petsValue': 'nicht erlaubt',
		'room.detail.card.breakdown.title': 'Preisaufschlüsselung',
		'room.detail.card.breakdown.nightLabel': 'Übernachtung',
		'room.detail.card.breakdown.nightFrom': 'ab',
		...
		'room.detail.card.note': 'Buchung erfolgt über unseren Partner. Es entstehen noch keine Kosten.',
		'room.detail.gallery.floorplanBadge': 'Grundriss',
		'room.detail.gallery.floorplanCaption': 'Grundriss ansehen',
		'room.detail.gallery.close': 'Galerie schließen',
		'room.detail.gallery.prev': 'Vorheriges',
		'room.detail.gallery.next': 'Nächstes',
		...
		'rooms.filter.double': 'Appartements',
		'rooms.filter.suites': 'Appartements',
		...
		'rooms.page.card.1.type': 'Appartement',
		...
		'rooms.page.card.2.title': 'Panorama-Appartement "Gletscherblick"',
		'rooms.page.card.2.type': 'Appartement',
		'rooms.page.card.2.meta': '65 m² · 2-3 Personen',
		'rooms.page.card.2.body':
			'Großzügiges Appartement mit offenem Kamin und privater Sauna für entspannte Abende.',
		...
		'amenity.herd': 'Herd',
		'amenity.ausziehcouch': 'Ausziehcouch',
		'amenity.badezimmer': 'Badezimmer',
		...
		'experiences.body':
			'Das Gitschtal rund um Weißbriach ist eine ruhige Basis für aktive Tage - mit Natur, Wanderungen und Radwegen direkt vor der Haustür.',
		'experiences.tabs.summer': 'Sommer',
		'experiences.tabs.winter': 'Winter',
		...
		'experiences.badge.recommended': 'Empfohlen',
		'experiences.badge.topExperience': 'Top Erlebnis',
		'experiences.badge.insider': 'Geheimtipp',
		'experiences.event.summer.hike.kicker': 'Wandern',
		'experiences.event.summer.hike.title': 'Reißkofel & Almen',
		'experiences.event.summer.hike.description':
			'Zwischen Weißbriach und den Karnischen Alpen warten aussichtsreiche Wege - von Genussrunden bis zur echten Gipfeltour.',
		'experiences.event.summer.lake.kicker': 'Seen',
		'experiences.event.summer.lake.title': 'Weißensee genießen',
		'experiences.event.summer.lake.description':
			'Türkisblaues Wasser, helle Holzstege und barfuß ins Glück am Ufer.',
		'experiences.event.summer.bike.kicker': 'Radfahren',
		'experiences.event.summer.bike.title': 'Gailtalradweg R3',
		'experiences.event.summer.bike.description':
			'Ruhig rollen, Berge links und rechts, und zwischendurch ein Eis am Fluss.',
		'experiences.event.summer.lift.kicker': 'Bergbahnen',
		...
		'experiences.event.winter.ice.description':
			'Internationale Winterbühne mit Europas größter präparierter Natureisfläche, Eislaufen, Winterwandern und Langlauf direkt am See.',
		'experiences.event.winter.hike.kicker': 'Skigebiet',
		'experiences.event.winter.hike.title': 'Skigebiet Weißbriach',
		'experiences.event.winter.hike.description':
			'Klein, übersichtlich und familienfreundlich, perfekt für Anfänger und Kinder ohne Stress und lange Wartezeiten.',
		'experiences.event.winter.crosscountry.kicker': 'Loipenregion',
		'experiences.event.winter.crosscountry.title': 'Gitschtaler Loipen',
		'experiences.event.winter.crosscountry.description':
			'Weißbriach Loipe und Gitschtal Genussloipe in sonniger Tallage, ideal für ruhige Wintertage abseits des Trubels.',
		'experiences.event.winter.snowshoe.kicker': 'Schneeschuh am Nassfeld',
		'experiences.event.winter.snowshoe.title': 'Schneeschuh am Nassfeld',
		'experiences.event.winter.snowshoe.description':
			'Tressdorfer Alm, Sonnenalpe Nassfeld und Garnitzenalm Wintertour bieten Panorama, Ruhe und echte Winter-Natur.',
		'experiences.event.winter.sledding.kicker': 'Rodeln',
		'experiences.event.winter.sledding.title': 'Rodeln: Nassfeld & Weißbriach',
		'experiences.event.winter.sledding.description':
			'Beleuchtete Rodelstrecken und Abendprogramm für Familien, kombiniert mit der ruhigen Winterstimmung im Gitschtal.',
		'experiences.meta.shortwalk': 'Kurz & lohnend',
		'experiences.meta.goldenhour': 'Perfekt fürs Foto',
		'experiences.meta.cooling': 'An heißen Tagen',
		'experiences.meta.easy': 'Kurz & erfrischend',
		'experiences.meta.boardwalks': 'Holzstege',
		'experiences.meta.waterfalls': 'Wasserfälle',
		'experiences.meta.regional': 'Regional',
		'experiences.meta.takehome': 'Souvenir zum Mitnehmen',
		...
		'experiences.meta.familyfun': 'Spaß für Familien',
		'experiences.meta.evening': 'Ideal am Abend',
		...
		'experiences.interests.hiking': 'Wandern',
		'experiences.interests.active': 'Aktivurlaub',
		'experiences.interests.family': 'Familie',
		'experiences.interests.lakes': 'Seen & Baden',
		'experiences.interests.culture': 'Genuss & Kultur',
		'experiences.interests.winter': 'Winterurlaub',
		'experiences.nav.kicker': 'Navigation',
		'experiences.nav.title': 'Auf dieser Seite',
		'experiences.nav.activities': 'Aktivitäten',
		'experiences.nav.highlights': 'Highlights',
		'experiences.nav.festivals': 'Traditionelle Feste',
		'experiences.nav.destinations': 'Ausflugsideen',
		'experiences.nav.guestcard': 'GästeCard',
		'experiences.nav.filters': 'Filter',
		'experiences.nav.reset': 'Zurücksetzen',
		'experiences.nav.apply': 'Anwenden',
		'experiences.nav.season': 'Saison',
		'experiences.nav.seasonAll': 'Alle',
		'experiences.nav.seasonByTab': 'Nach Saison',
		'experiences.nav.summer': 'Sommer',
		'experiences.nav.winter': 'Winter',
		'experiences.quickIdeas.title': 'Weitere Ideen',
		'experiences.quickIdeas.summer.picknick': 'Picknick-Spot',
		'experiences.quickIdeas.summer.farmshop': 'Bauernhofladen',
		'experiences.quickIdeas.summer.sunsetspot': 'Aussichtspunkt bei Sonnenuntergang',
		'experiences.quickIdeas.summer.familyprogram': 'Kinderprogramm',
		'experiences.quickIdeas.summer.almrunde': 'Leichte Almrunde',
		'experiences.quickIdeas.summer.swimday': 'Badetag am See',
		'experiences.quickIdeas.winter.badweather': 'Schlechtwetter-Plan',
		'experiences.quickIdeas.winter.romanticwalk': 'Romantische Runde',
		'experiences.quickIdeas.winter.kidsprogram': 'Kinderprogramm',
		'experiences.quickIdeas.winter.sleddingnight': 'Rodeln am Abend',
		'experiences.quickIdeas.winter.spa': 'Therme & Spa-Day',
		'experiences.quickIdeas.winter.villagemarket': 'Kleines Dorffest',
		'experiences.base.kicker': 'Ihr perfekter Ausgangspunkt',
		'experiences.base.title': 'Gästehaus Rader als Base für Ihre Auszeit',
		'experiences.base.body':
			'Starten Sie direkt vor der Haustür in Ihren Urlaubstag und kommen Sie am Abend entspannt zurück. Gerne helfen wir Ihnen bei der passenden Planung für Ihre Interessen und die aktuelle Saison.',
		'experiences.base.cta.rooms': 'Appartements ansehen',
		'experiences.base.cta.booking': 'Verfügbarkeit prüfen',
		'experiences.event.summer.hike.meta1': 'Viele Almwege in der Nähe',
		'experiences.event.summer.hike.meta2': 'Beste Zeit: Juni bis Oktober',
		'experiences.event.summer.lake.meta1': 'Badeplätze in kurzer Fahrzeit',
		'experiences.event.summer.lake.meta2': 'Ideal für Familien & Ruhetage',
		'experiences.event.summer.bike.meta1': 'Direkter Einstieg ins Radnetz',
		...
		'experiences.event.winter.hike.meta1': 'Familienfreundliche Pisten',
		'experiences.event.winter.hike.meta2': 'Keine langen Wartezeiten',
		'experiences.event.winter.crosscountry.meta1': 'Weißbriach Loipe',
		'experiences.event.winter.crosscountry.meta2': 'Gitschtal Genussloipe',
		...
		'experiences.destinations.weissensee.kicker': 'SEEN',
		'experiences.destinations.weissensee.title': 'Weißensee genießen',
		'experiences.destinations.weissensee.body':
			'Türkisblaues Wasser, ruhige Buchten und Holzstege am Ufer - perfekt zum Baden, Spazieren und Durchatmen in einer der schönsten Naturkulissen Kärntens.',
		...
		'experiences.destinations.presseggersee.kicker': 'SEEN',
		'experiences.destinations.presseggersee.title': 'Pressegger See erleben',
		'experiences.destinations.presseggersee.body':
			'Warm, familienfreundlich und ideal für entspannte Badetage: flache Einstiege, große Liegewiesen und echtes Sommergefühl nur wenige Minuten entfernt.',
		...
		'experiences.destinations.tags.clearLake': 'Kristallklarer Badesee',
		'experiences.destinations.tags.natureCalm': 'Naturparadies & Ruhe',
		'experiences.destinations.tags.summerWinterHighlight': 'Sommer & Winter Highlight',
		'experiences.destinations.tags.warmWater': 'Besonders warmes Wasser',
		'experiences.destinations.tags.familyIdeal': 'Ideal für Familien',
		'experiences.destinations.tags.shortDrive': 'Kurze Fahrzeit vom Gästehaus',
		...
		'cta.secondary': 'Appartements & Preise ansehen',
		'trust.kicker': 'Vertrauen',
		'trust.title': 'Gastfreundschaft, die ankommt',
		...
		'trust.review.2.name': 'Marcel D. K.',
		'trust.review.2.initials': 'MDK',
		'trust.review.2.meta': 'vor einem Jahr',
		'trust.review.3':
		...
		'trust.booking.score': '9,5 / 10',
		'trust.booking.scoreCompact': '9,5',
		'trust.booking.label': 'Hervorragend',
		'trust.booking.meta': '38 Bewertungen',
		'trust.airbnb.score': '5,0 / 5',
		...
		'guestcard.experiences.wellness.card1.body':
			'Vergünstigungen bei ausgewählten Badeangeboten - ideal für entspannte Sommertage.',
		...
		'guestcard.experiences.wellness.card3.body':
			'Mit Vorteilen bei ausgewählten Sauna- und Wohlfühlangeboten in der Region.',
		...
		'home.gallery.title': 'Einblicke in unser Gästehaus im Gitschtal',
		'home.gallery.subtitle':
			'Einblicke in unsere Appartements, das Gästehaus und das Gitschtal - damit Sie schon vor der Anfrage ein gutes Gefühl für Ihren Aufenthalt bekommen.',
		'home.gallery.cta': 'Alle Bilder ansehen',
		'home.gallery.locationTag': 'Weißbriach • Kärnten',
		'home.gallery.locationTag.nassfeld': 'Tröpolach • Nassfeld',
		...
		'home.gallery.imageAlt.view': 'Ihre Gastgeber',
		'home.gallery.imageAlt.kirche': 'Kirche in Weißbriach',
		'home.gallery.imageAlt.pavillon': 'Pavillon beim Gästehaus',
		...
		'home.gallery.imageAlt.nr1LivingRoom': 'Wohnbereich im Appartement Nº 1',
		'home.gallery.imageAlt.nr1Bedroom': 'Schlafbereich im Appartement Nº 1',
		'home.gallery.imageAlt.nr2Hero': 'Appartement Nº 2 mit Schlafbereich',
		'home.gallery.imageAlt.nr2LivingRoom': 'Wohnzimmer im Appartement Nº 2',
		'home.gallery.imageAlt.nr3Sofa': 'Wohnbereich im Appartement Nº 3',
		'home.gallery.imageAlt.nr3Bed': 'Schlafbereich im Appartement Nº 3',
		'home.gallery.imageAlt.winterBalkon': 'Winterlicher Balkon-Ausblick',
		'home.gallery.imageAlt.dorfblickWinter': 'Winterlicher Dorfblick in Weißbriach',
		'home.gallery.imageAlt.kircheWinter': 'Kirche in Weißbriach im Winter',
		'home.gallery.imageAlt.nassfeldSki': 'Skifahren am Nassfeld',
		...
		'imprint.company.addressLine1': 'Weißbriach 92',
		'imprint.company.addressLine2': '9622 Weißbriach, Österreich',
		'imprint.company.phone': 'Telefon',
		'imprint.company.email': 'E-Mail',
		'imprint.legal.title': 'Rechtliche Angaben',
		'imprint.legal.legalForm.label': 'Rechtsform',
		'imprint.legal.legalForm.value': 'Privatvermietung',
		'imprint.legal.companyRegister.label': 'Firmenbuchnummer',
		'imprint.legal.companyRegister.value': 'nicht im Firmenbuch eingetragen',
		'imprint.legal.registerCourt.label': 'Firmenbuchgericht',
		'imprint.legal.registerCourt.value': 'entfällt',
		'imprint.legal.vatId.label': 'UID-Nummer',
		'imprint.legal.vatId.value': 'entfällt',
		'imprint.legal.authority.label': 'Gewerbebehörde',
		'imprint.legal.authority.value': 'Bezirkshauptmannschaft Hermagor',
		'imprint.legal.profession.label': 'Berufsbezeichnung',
		'imprint.legal.profession.value': 'Beherbergungsbetrieb / Privatvermietung',
		'imprint.legal.country.label': 'Staat der Verleihung',
		'imprint.legal.country.value': 'Österreich',
		'imprint.legal.mediaOwner.label': 'Medieninhaber (§25 MedienG)',
		'imprint.legal.mediaOwner.value': 'Familie Herold-Hueber, Weißbriach 92, 9622 Weißbriach',
		'imprint.legal.businessPurpose.label': 'Unternehmensgegenstand',
		'imprint.legal.businessPurpose.value': 'Beherbergung von Gästen',
		'imprint.liability.content.title': 'Haftung für Inhalte',
		'imprint.liability.content.body':
			'Wir entwickeln die Inhalte dieser Website laufend weiter und bemühen uns, korrekte und aktuelle Informationen bereitzustellen. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte können wir keine Haftung übernehmen.',
		'imprint.liability.links.title': 'Haftung für Links',
		'imprint.liability.links.body':
			'Unsere Website enthält Links zu externen Websites, für deren Inhalte wir nicht verantwortlich sind. Bei Kenntnis von Rechtsverletzungen werden wir derartige Links umgehend entfernen.',
		...
		'contact.cta.book': 'Jetzt buchen',
		'contact.cta.call': 'Anrufen',
		'contact.cta.callNow': 'Jetzt anrufen',
		'contact.cta.whatsapp': 'WhatsApp schreiben',
		'contact.cta.email': 'E-Mail schreiben',
		'contact.cta.sendMessage': 'Nachricht senden',
		'contact.cta.sendEmail': 'E-Mail senden',
		'contact.cta.callLandline': 'Festnetz anrufen',
		...
		'contact.route.cta': 'Route planen',
		'contact.checkin.title': 'Check-in & Check-out',
		'contact.direct.title': 'Direktkontakt',
		'contact.map.label': 'Google Maps',
		'contact.map.title': 'Anfahrt & Lage',
		'contact.map.description':
			'Zum Anzeigen der Karte werden Daten an Google übertragen.',
		'contact.map.load': 'Karte laden',
		'contact.map.open': 'Route in Google Maps',
		'contact.map.tip': 'Hinweis: Sie können die Karte jederzeit später laden.',
		'contact.map.iframeTitle': 'Karte: Gästehaus Rader',
		'contact.map.close': 'Karte schließen',
		'contact.payment.title': 'Zahlungsdaten',
		'contact.payment.subtitle': 'Für Überweisungen (z. B. Anzahlung nach Vereinbarung).',
		'contact.payment.copy': 'Kopieren',
		'contact.payment.copied': 'Kopiert!',
		'contact.payment.copyIban': 'IBAN kopieren',
		'contact.payment.copyBic': 'BIC kopieren',
		'contact.trust.title': 'Gut zu wissen',
		'contact.trust.response': 'Wir antworten meist innerhalb von 24 Stunden.',
		'contact.trust.languages': 'Sprachen: Deutsch / Englisch',
		'contact.trust.checkin': 'Check-in ab 14:00 Uhr, Check-out bis 10:00 Uhr.',
		'contact.trust.parking': 'Kostenloser Parkplatz direkt am Haus.',
		'contact.trust.responseShort': 'Antwort meist < 24h',
		'contact.trust.languagesShort': 'Deutsch / Englisch',
		'contact.trust.checkinShort': 'Check-in 14:00 · Check-out 10:00',
		'contact.trust.parkingShort': 'Kostenlos parken',
		...
		'faq.guestcard.q2': 'Wie erhalte ich die GästeCard Basic?',
		'faq.guestcard.a2':
			'Sie erhalten die GästeCard Basic direkt bei Ihrer Ankunft in unserer Unterkunft. Die Karte ist kostenlos, personengebunden und für die gesamte Dauer Ihres Aufenthalts gültig - inklusive An- und Abreisetag.',
		'faq.guestcard.q3': 'Was ist beim öffentlichen Verkehr inkludiert?',
		'faq.guestcard.a3':
			'Mit der GästeCard Basic nutzen Sie regionale Linienbusse kostenlos. Zusätzlich können Sie - mit einer gültigen Gästekarte - S-Bahn-Linien und ausgewählte Regionalverbindungen in Kärnten nutzen. Für Details und Ausnahmen (z. B. Fahrradmitnahme) gelten die offiziellen Bestimmungen.',
	...
	en: {
		'nav.home': 'Home',
		'nav.roomsShort': 'Apartments',
		'nav.about': 'About',
		'nav.rooms': 'Apartments & Prices',
		'nav.wellness': 'Wellness',
		...
		'usp.1.title': 'Your retreat in the Gitschtal',
		'usp.1.body': 'A calm holiday experience instead of mass tourism, with space to truly unwind.',
		'usp.2.title': 'Everything close – without stress',
		'usp.2.body': 'Lakes, mountains, hiking, and skiing are nearby and easy to reach.',
		'usp.3.title': 'Hosts who are truly present',
		'usp.3.body': 'Family-run across generations - personal, warm, and attentive.',
		'usp.4.title': 'Nature right outside your door',
		'usp.4.body': 'Ski areas, hiking trails, and panoramic views start just minutes away.',
		'rooms.preview.title': 'Apartments & Prices',
		...
		'rooms.section.title': 'Our apartments',
		'rooms.section.cta': 'View all apartments',
		'home.trustbar.family': 'Family-run',
		'home.trustbar.quiet': 'Quiet location',
		'home.trustbar.guestcard': 'Free guest card',
		'home.trustbar.reviews': 'Top reviews',
		...
		'rooms.page.pricing.tax.note': 'Increase from May 1 to € 4.50',
		'rooms.page.pricing.tax.price': '€ 2.70',
		...
		'rooms.page.info.cancellation.link': 'Europäische Reiseversicherung',
		'room.detail.back': 'Back',
		'room.detail.gallery.more': 'photos',
		'room.detail.share': 'Share',
		'room.detail.shareCopied': 'Link copied',
		'room.detail.info.size': 'Size',
		'room.detail.info.floor': 'Floor',
		'room.detail.info.view': 'View',
		'room.detail.info.guests': 'Guests',
		'room.detail.sections.homeTitle': 'Your home in the Alps',
		'room.detail.sections.amenities': 'Amenities',
		'room.detail.sections.floorplan': 'Floor plan',
		'room.detail.sections.prices': 'Prices & details',
		'room.detail.sections.reviews': 'Guest reviews',
		'room.detail.prices.season': 'Season',
		'room.detail.prices.priceNight': 'Price / night',
		'room.detail.prices.extraPerson': 'Surcharge per additional person',
		'room.detail.prices.extraPersonShort': 'Surcharge / person',
		'room.detail.prices.minStay': 'Minimum stay',
		'room.detail.prices.note':
			'All prices are for 2 people incl. VAT, plus final cleaning (one-time €45) and local tax.',
		'room.detail.reviews.prev': 'Previous reviews',
		'room.detail.reviews.next': 'Next reviews',
		'room.detail.card.priceFrom': 'Price from',
		'room.detail.card.vatNote': 'incl. VAT, plus final cleaning & local tax',
		'room.detail.card.facts.title': 'Quick facts',
		'room.detail.card.facts.checkinLabel': 'Check-in',
		'room.detail.card.facts.checkinValue': 'from 2:00 PM',
		'room.detail.card.facts.checkoutLabel': 'Check-out',
		'room.detail.card.facts.checkoutValue': 'until 10:00 AM',
		'room.detail.card.facts.minStayLabel': 'Minimum stay',
		'room.detail.card.facts.minStayValue': '3 nights',
		'room.detail.card.facts.cancelLabel': 'Cancellation',
		'room.detail.card.facts.cancelValue': 'per hotel terms',
		'room.detail.card.facts.petsLabel': 'Pets',
		'room.detail.card.facts.petsValue': 'not allowed',
		'room.detail.card.breakdown.title': 'Price breakdown',
		'room.detail.card.breakdown.nightLabel': 'Overnight stay',
		'room.detail.card.breakdown.nightFrom': 'from',
		...
		'room.detail.card.note': 'Booking is handled by our partner. No charges yet.',
		'room.detail.gallery.floorplanBadge': 'Floor plan',
		'room.detail.gallery.floorplanCaption': 'View floor plan',
		'room.detail.gallery.close': 'Close gallery',
		'room.detail.gallery.prev': 'Previous',
		'room.detail.gallery.next': 'Next',
		'rooms.filter.title': 'Filter',
		'rooms.filter.subtitle': 'Refine your search',
		'rooms.filter.category': 'Category',
		'rooms.filter.all': 'Show all',
		'rooms.filter.double': 'Apartments',
		'rooms.filter.suites': 'Apartments',
		'rooms.filter.apartments': 'Apartments',
		'rooms.filter.price': 'Price per night (€)',
		'rooms.filter.amenities': 'Amenities',
		'rooms.page.card.1.title': 'Alpenrose Deluxe',
		'rooms.page.card.1.type': 'Apartment',
		'rooms.page.card.1.meta': '35 m² · 2 guests',
		'rooms.page.card.1.body':
			'Enjoy the scent of pine wood and panoramic views of the peaks.',
		'rooms.page.card.1.price': '145',
		'rooms.page.card.2.title': 'Panorama Apartment "Glacier View"',
		'rooms.page.card.2.type': 'Apartment',
		'rooms.page.card.2.meta': '65 m² · 2-3 guests',
		'rooms.page.card.2.body':
			'Spacious apartment with open fireplace and private sauna for relaxed evenings.',
		'rooms.page.card.2.price': '280',
		...
		'amenity.kueche': 'Kitchen',
		'amenity.kuehlschrank': 'Fridge',
		'amenity.mikrowelle': 'Microwave',
		'amenity.herd': 'Stove',
		'amenity.ausziehcouch': 'Sofa bed',
		'amenity.badezimmer': 'Bathroom',
		...
		'experiences.body':
			'The Gitschtal around Weißbriach is a calm base for active days - with nature, hiking routes, and cycling paths right at your doorstep.',
		...
		'experiences.badge.recommended': 'Recommended',
		'experiences.badge.topExperience': 'Top experience',
		'experiences.badge.insider': 'Insider tip',
		'experiences.event.summer.hike.kicker': 'Hiking',
		'experiences.event.summer.hike.title': 'Reißkofel & alpine huts',
		'experiences.event.summer.hike.description':
			'From scenic rounds to real summit hikes, beautiful trails run between Weißbriach and the Carnic Alps.',
		'experiences.event.summer.lake.kicker': 'Lakes',
		'experiences.event.summer.lake.title': 'Enjoy Lake Weißensee',
		'experiences.event.summer.lake.description':
			'Turquoise water, sunlit wooden piers, and bare feet at the shore.',
		'experiences.event.summer.bike.kicker': 'Cycling',
		'experiences.event.summer.bike.title': 'Gailtal cycle path R3',
		'experiences.event.summer.bike.description':
			'Roll easy with mountains on both sides, then grab an ice cream by the river.',
		'experiences.event.summer.lift.kicker': 'Lifts',
		...
		'experiences.event.winter.ice.description':
			'International winter highlight with Europe’s largest prepared natural ice surface, plus skating, winter walking, and lakeside cross-country routes.',
		'experiences.event.winter.hike.kicker': 'Ski area',
		'experiences.event.winter.hike.title': 'Weißbriach Ski Area',
		'experiences.event.winter.hike.description':
			'Small, manageable, and family-friendly, perfect for beginners and kids without stress or long lift queues.',
		'experiences.event.winter.crosscountry.kicker': 'Trail region',
		'experiences.event.winter.crosscountry.title': 'Gitschtal Trails',
		'experiences.event.winter.crosscountry.description':
			'Weißbriach trail and Gitschtal Genussloipe in a sunny valley setting, great for calm winter days away from crowds.',
		'experiences.event.winter.snowshoe.kicker': 'Snowshoe at Nassfeld',
		'experiences.event.winter.snowshoe.title': 'Snowshoe at Nassfeld',
		'experiences.event.winter.snowshoe.description':
			'Tressdorfer Alm, Sonnenalpe Nassfeld, and the Garnitzenalm winter tour offer panorama, quiet, and true alpine winter nature.',
		'experiences.event.winter.sledding.kicker': 'Sledding',
		'experiences.event.winter.sledding.title': 'Sledding: Nassfeld & Weißbriach',
		'experiences.event.winter.sledding.description':
			'Lit sledding runs and evening family programs, combined with the calm winter atmosphere of the Gitschtal valley.',
		'experiences.meta.shortwalk': 'Short and rewarding',
		'experiences.meta.goldenhour': 'Perfect for photos',
		'experiences.meta.cooling': 'Great on hot days',
		'experiences.meta.easy': 'Short and refreshing',
		'experiences.meta.boardwalks': 'Wooden walkways',
		'experiences.meta.waterfalls': 'Waterfalls',
		'experiences.meta.regional': 'Regional',
		'experiences.meta.takehome': 'Take-home souvenir',
		...
		'experiences.meta.familyfun': 'Family fun',
		'experiences.meta.evening': 'Best in the evening',
		...
		'experiences.interests.hiking': 'Hiking',
		'experiences.interests.active': 'Active holiday',
		'experiences.interests.family': 'Family',
		'experiences.interests.lakes': 'Lakes & swimming',
		'experiences.interests.culture': 'Food & culture',
		'experiences.interests.winter': 'Winter holiday',
		'experiences.nav.kicker': 'Navigation',
		'experiences.nav.title': 'On this page',
		'experiences.nav.activities': 'Activities',
		'experiences.nav.highlights': 'Highlights',
		'experiences.nav.festivals': 'Traditional festivals',
		'experiences.nav.destinations': 'Destinations',
		'experiences.nav.guestcard': 'Guest Card',
		'experiences.nav.filters': 'Filters',
		'experiences.nav.reset': 'Reset',
		'experiences.nav.apply': 'Apply',
		'experiences.nav.season': 'Season',
		'experiences.nav.seasonAll': 'All',
		'experiences.nav.seasonByTab': 'By season',
		'experiences.nav.summer': 'Summer',
		'experiences.nav.winter': 'Winter',
		'experiences.quickIdeas.title': 'More ideas',
		'experiences.quickIdeas.summer.picknick': 'Picnic spot',
		'experiences.quickIdeas.summer.farmshop': 'Farm shop',
		'experiences.quickIdeas.summer.sunsetspot': 'Sunset viewpoint',
		'experiences.quickIdeas.summer.familyprogram': 'Kids program',
		'experiences.quickIdeas.summer.almrunde': 'Easy alpine loop',
		'experiences.quickIdeas.summer.swimday': 'Lake swim day',
		'experiences.quickIdeas.winter.badweather': 'Bad-weather plan',
		'experiences.quickIdeas.winter.romanticwalk': 'Romantic walk',
		'experiences.quickIdeas.winter.kidsprogram': 'Kids program',
		'experiences.quickIdeas.winter.sleddingnight': 'Evening sledding',
		'experiences.quickIdeas.winter.spa': 'Spa day',
		'experiences.quickIdeas.winter.villagemarket': 'Small village event',
		'experiences.base.kicker': 'Your ideal home base',
		'experiences.base.title': 'Guesthouse Rader as your base for every day',
		'experiences.base.body':
			'Start your day right from our doorstep and return in the evening to calm surroundings. We are happy to help you plan the best options for your interests and the current season.',
		'experiences.base.cta.rooms': 'View apartments',
		'experiences.base.cta.booking': 'Check availability',
		'experiences.event.summer.hike.meta1': 'Many alpine trails nearby',
		'experiences.event.summer.hike.meta2': 'Best season: June to October',
		'experiences.event.summer.lake.meta1': 'Swimming spots within short drive',
		'experiences.event.summer.lake.meta2': 'Great for families and relaxed days',
		'experiences.event.summer.bike.meta1': 'Direct access to bike routes',
		...
		'experiences.event.winter.hike.meta1': 'Family-friendly slopes',
		'experiences.event.winter.hike.meta2': 'No long queue times',
		'experiences.event.winter.crosscountry.meta1': 'Weißbriach trail',
		'experiences.event.winter.crosscountry.meta2': 'Gitschtal Genussloipe',
		...
		'experiences.destinations.weissensee.kicker': 'LAKES',
		'experiences.destinations.weissensee.title': 'Enjoy Lake Weißensee',
		'experiences.destinations.weissensee.body':
			'Turquoise water, quiet coves, and wooden boardwalks along the shore - perfect for swimming, gentle walks, and deep breaths in one of Carinthia’s most beautiful natural settings.',
		...
		'experiences.destinations.presseggersee.kicker': 'LAKES',
		'experiences.destinations.presseggersee.title': 'Experience Lake Pressegger',
		'experiences.destinations.presseggersee.body':
			'Warm, family-friendly, and ideal for relaxed swim days: shallow entries, large sunbathing lawns, and true summer feeling just minutes away.',
		...
		'experiences.destinations.tags.regional': 'Regional',
		'experiences.destinations.tags.clearLake': 'Crystal-clear swimming lake',
		'experiences.destinations.tags.natureCalm': 'Nature paradise & calm',
		'experiences.destinations.tags.summerWinterHighlight': 'Summer & winter highlight',
		'experiences.destinations.tags.warmWater': 'Especially warm water',
		'experiences.destinations.tags.familyIdeal': 'Ideal for families',
		'experiences.destinations.tags.shortDrive': 'Short drive from guesthouse',
		...
		'cta.secondary': 'View apartments & prices',
		'trust.kicker': 'Trust',
		'trust.title': 'Hospitality that resonates',
		...
		'trust.review.2.name': 'Marcel D. K.',
		'trust.review.2.initials': 'MDK',
		'trust.review.2.meta': '1 year ago',
		'trust.review.3':
		...
		'trust.booking.score': '9.5 / 10',
		'trust.booking.scoreCompact': '9.5',
		'trust.booking.label': 'Exceptional',
		'trust.booking.meta': '38 reviews',
		'trust.airbnb.score': '5.0 / 5',
		'trust.airbnb.label': 'Airbnb',
		...
		'guestcard.experiences.wellness.card1.body':
			'Discounts for selected swimming offers - ideal for relaxing summer days.',
		...
		'guestcard.experiences.wellness.card3.title': 'Sauna & wellness',
		'guestcard.experiences.wellness.card3.body':
			'Benefits for selected sauna and wellness offers in the region.',
		...
		'home.gallery.title': 'Insights into our guesthouse in the Gitschtal',
		'home.gallery.subtitle':
			'A closer look at our apartments, the guesthouse, and the Gitschtal so you can get a feel for your stay before sending an inquiry.',
		'home.gallery.cta': 'View all photos',
		'home.gallery.locationTag': 'Weissbriach • Carinthia',
		'home.gallery.locationTag.nassfeld': 'Troepolach • Nassfeld',
		...
		'home.gallery.imageAlt.view': 'Your hosts',
		'home.gallery.imageAlt.kirche': 'Church in Weißbriach',
		'home.gallery.imageAlt.pavillon': 'Pavilion at the guesthouse',
		...
		'home.gallery.imageAlt.nr1LivingRoom': 'Living area in Apartment Nº 1',
		'home.gallery.imageAlt.nr1Bedroom': 'Sleeping area in Apartment Nº 1',
		'home.gallery.imageAlt.nr2Hero': 'Apartment Nº 2 with sleeping area',
		'home.gallery.imageAlt.nr2LivingRoom': 'Living room in Apartment Nº 2',
		'home.gallery.imageAlt.nr3Sofa': 'Living area in Apartment Nº 3',
		'home.gallery.imageAlt.nr3Bed': 'Sleeping area in Apartment Nº 3',
		'home.gallery.imageAlt.winterBalkon': 'Winter balcony view',
		'home.gallery.imageAlt.dorfblickWinter': 'Winter village view in Weissbriach',
		'home.gallery.imageAlt.kircheWinter': 'Church in Weissbriach in winter',
		'home.gallery.imageAlt.nassfeldSki': 'Skiing at Nassfeld',
		...
		'imprint.company.addressLine1': 'Weißbriach 92',
		'imprint.company.addressLine2': '9622 Weißbriach, Austria',
		'imprint.company.phone': 'Phone',
		'imprint.company.email': 'Email',
		'imprint.legal.title': 'Legal information',
		'imprint.legal.legalForm.label': 'Legal form',
		'imprint.legal.legalForm.value': 'Private rental',
		'imprint.legal.companyRegister.label': 'Company register',
		'imprint.legal.companyRegister.value': 'not registered in the company register',
		'imprint.legal.registerCourt.label': 'Register court',
		'imprint.legal.registerCourt.value': 'not applicable',
		'imprint.legal.vatId.label': 'VAT ID',
		'imprint.legal.vatId.value': 'not applicable',
		'imprint.legal.authority.label': 'Supervisory authority',
		'imprint.legal.authority.value': 'District Authority Hermagor',
		'imprint.legal.profession.label': 'Professional title',
		'imprint.legal.profession.value': 'Accommodation business / private rental',
		'imprint.legal.country.label': 'Country of award',
		'imprint.legal.country.value': 'Austria',
		'imprint.legal.mediaOwner.label': 'Media owner (§25 MedienG)',
		'imprint.legal.mediaOwner.value': 'Herold-Hueber family, Weißbriach 92, 9622 Weißbriach',
		'imprint.legal.businessPurpose.label': 'Business purpose',
		'imprint.legal.businessPurpose.value': 'Accommodation of guests',
		'imprint.liability.content.title': 'Liability for content',
		'imprint.liability.content.body':
			'We continuously develop the content of this website and strive to provide correct and up-to-date information. We assume no liability for the accuracy, completeness, or timeliness of the content.',
		'imprint.liability.links.title': 'Liability for links',
		'imprint.liability.links.body':
			'Our website contains links to external websites for whose content we are not responsible. If we become aware of legal violations, we will remove such links promptly.',
		...
		'contact.cta.book': 'Book now',
		'contact.cta.call': 'Call',
		'contact.cta.callNow': 'Call now',
		'contact.cta.whatsapp': 'Write on WhatsApp',
		'contact.cta.email': 'Write email',
		'contact.cta.sendMessage': 'Send message',
		'contact.cta.sendEmail': 'Send email',
		'contact.cta.callLandline': 'Call landline',
		...
		'contact.route.cta': 'Plan route',
		'contact.checkin.title': 'Check-in & check-out',
		'contact.direct.title': 'Direct contact',
		'contact.map.label': 'Google Maps',
		'contact.map.title': 'Directions & location',
		'contact.map.description':
			'Displaying the map sends data to Google.',
		'contact.map.load': 'Load map',
		'contact.map.open': 'Open route in Google Maps',
		'contact.map.tip': 'Note: You can load the map later at any time.',
		'contact.map.iframeTitle': 'Map: Guesthouse Rader',
		'contact.map.close': 'Close map',
		'contact.payment.title': 'Payment details',
		'contact.payment.subtitle': 'For bank transfers (e.g. deposit by arrangement).',
		'contact.payment.copy': 'Copy',
		'contact.payment.copied': 'Copied!',
		'contact.payment.copyIban': 'Copy IBAN',
		'contact.payment.copyBic': 'Copy BIC',
		'contact.trust.title': 'Good to know',
		'contact.trust.response': 'We usually reply within 24 hours.',
		'contact.trust.languages': 'Languages: German / English',
		'contact.trust.checkin': 'Check-in from 2:00 pm, check-out by 10:00 am.',
		'contact.trust.parking': 'Free parking directly at the guesthouse.',
		'contact.trust.responseShort': 'Usually reply < 24h',
		'contact.trust.languagesShort': 'German / English',
		'contact.trust.checkinShort': 'Check-in 2:00 pm · Check-out 10:00 am',
		'contact.trust.parkingShort': 'Free parking',
		...
		'faq.guestcard.q2': 'How do I get the Guest Card Basic?',
		'faq.guestcard.a2':
			'You receive the Guest Card Basic directly on arrival at our accommodation. The card is free, personal, and valid for your entire stay, including arrival and departure day.',
		'faq.guestcard.q3': 'What is included in public transport?',
		'faq.guestcard.a3':
			'With the Guest Card Basic, regional bus lines are included free of charge. With a valid guest card, you can also use S-Bahn lines and selected regional rail services in Carinthia. Official rules apply for details and exceptions (e.g. bike transport).',

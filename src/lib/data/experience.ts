...
export const experienceEvents: ExperienceEvent[] = [
	...
	},
	{
		...
		icon: Utensils,
		kicker: { de: 'Genusskultur', en: 'Food culture' },
		title: { de: 'Gailtaler Spezialitäten', en: 'Gailtal specialities' },
		description: {
			de: 'Gailtaler Speck, Almkäse, Kärntner Kasnudeln und Reindling gehören hier zur gelebten Alltags- und Festkultur - am besten auf Märkten, bei Kirchtagen oder nach einer Almwanderung entdecken.',
			en: 'Gailtaler Speck, alpine cheese, Carinthian Kasnudeln, and Reindling are part of everyday and festival culture here, best discovered at markets, church fairs, or after a mountain-hut walk.',
		},
		image: '/images/Umgebung/napal-alm.jpg',
		location: { de: 'Gailtal / Gitschtal', en: 'Gailtal / Gitschtal' },
		driveMinutes: 10,
		distanceKm: 8,
		durationHours: '2-4',
		difficulty: 'easy',
		...
		titleSize: 'text-xl',
		meta: [
			{ de: 'Gailtaler Speck', en: 'Gailtaler Speck' },
			{ de: 'Almkäse & Kasnudeln', en: 'Alpine cheese & Kasnudeln' },
			{ de: 'Märkte & Kirchtage', en: 'Markets & church fairs' },
			{ de: 'Regional', en: 'Regional' },
		],
		badge: { de: 'Regional', en: 'Regional' },
		badgeTier: 'tip',
	},
	{
		id: 'summer-golz',
